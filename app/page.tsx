...
import { InvoiceDrawer, Invoice } from "./components/InvoiceDrawer";
...
export default function App() {
  const { invoices, upsertInvoice, updateStatus, deleteInvoice } = useInvoices();
    ...
    <AnimatePresence mode="wait">
      {viewMode === "builder" ? (
        ...
        <motion.div
          ...
          animate="animate"
          exit="exit"
          className="flex min-h-screen bg-background text-foreground overflow-hidden w-full"
        >
          <Sidebar
          ...
          <AnimatePresence mode="wait">
            ...
            {activePage === "Settings" && <SettingsPage key="Settings" ws={ws} />}
